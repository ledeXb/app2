    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text(
            'ادات جميع ادوات اتكالي لنكس في تيرمكس',
            style: TextStyle(
              fontSize: 18,
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Row(
                            ...
                            children: const [
                              Text(
                                "يحتوي على جميع الأدوات المستخدمة في سلسلة الكالي لنكس",
                                style: TextStyle(
                                  fontSize: 12,
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            FlutterClipboard.copy(
                                'git clone https://github.com/ledeXb/Linux-.git');
                            {
                              showDialog(
                                context: context,
                                builder: (context) => AlertDialog(
                    ...
                    child: Column(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () {
                            FlutterClipboard.copy('cd Linux-');
                            {
                              showDialog(
                                context: context,
                                builder: (context) => AlertDialog(
                    ...
                    child: Column(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () {
                            FlutterClipboard.copy('python2 fsociety.py');
                            {
                              showDialog(
                                context: context,
                                builder: (context) => AlertDialog(
