                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Row(
                            ...
                            children: const [
                              Text(
                                "هذه الأداة هي وظيفة أداة بالنسبة لي لإجراء اختبار ping \n                     لي على الموقع واستخراج IP",
                                style: TextStyle(
                                  fontSize: 16,
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            FlutterClipboard.copy(
                                'git clone https://github.com/ledeXb/ping-ip.git');
                            {
                              showDialog(
                                context: context,
                                builder: (context) => AlertDialog(
                    ...
                    child: Column(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () {
                            FlutterClipboard.copy('cd ping-ip');
                            {
                              showDialog(
                                context: context,
                                builder: (context) => AlertDialog(
                    ...
                    child: Column(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () {
                            FlutterClipboard.copy('python XBIP.py');
                            {
                              showDialog(
                                context: context,
                                builder: (context) => AlertDialog(
